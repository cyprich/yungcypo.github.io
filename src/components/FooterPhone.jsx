...
const Footer = () => {
    ...
    return (
        <footer id={"footerphone"} className={"footerphone noprint phone"}>
            <div className="footerphonepismenka">
                <p style={{fontSize: "1.125em"}}>Cypo's Website <span style={{color: "var(--color7)"}}>v3.0.0</span>
                </p>
                <p style={{alignSelf: "flex-start"}}>2020 - 2024</p>
                <div className={"footerphonevyhlasenieupdates"}>
                    <Link to={"/disclaimer"}
                ...
                <div className={"footerphonetechnologie"}>
                    <p>Made with</p>
                    <div>
            ...
            <div className={"footerphoneobrazky"}>
                {
                    kontakt.map((e, key) => {
                        return (
                            <Link
