...
const Footer = () => {
    ...
    return (
        <footer id={"footer"} className={"footer noprint nophone"}>
            <div className={"footerprvacast"}>
                <p style={{fontSize: "1.125em"}}>Cypo's Website <span style={{color: "var(--color7)"}}>v3.0.0</span></p>
                <Link to={"/disclaimer"} className={"footerupdates"} title={"Vyhlásenie o vylúčení zodpovednosti"}>Vyhlásenie</Link>
